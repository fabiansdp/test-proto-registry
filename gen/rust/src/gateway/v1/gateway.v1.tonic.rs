...
pub mod stream_gateway_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn record_sensor(
            &mut self,
            request: impl tonic::IntoStreamingRequest<
                Message = super::RecordSensorRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::RecordSensorResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/gateway.v1.StreamGatewayService/RecordSensor",
            );
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gateway.v1.StreamGatewayService", "RecordSensor"),
                );
...
pub mod stream_gateway_service_server {
    ...
    pub trait StreamGatewayService: std::marker::Send + std::marker::Sync + 'static {
        async fn record_sensor(
            &self,
            request: tonic::Request<tonic::Streaming<super::RecordSensorRequest>>,
        ) -> std::result::Result<
            tonic::Response<super::RecordSensorResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/gateway.v1.StreamGatewayService/RecordSensor" => {
                    ...
                    struct RecordSensorSvc<T: StreamGatewayService>(pub Arc<T>);
                    impl<
                        T: StreamGatewayService,
                    > tonic::server::ClientStreamingService<super::RecordSensorRequest>
                    for RecordSensorSvc<T> {
                        type Response = super::RecordSensorResponse;
                        ...
                        fn call(
                            ...
                            request: tonic::Request<
                                tonic::Streaming<super::RecordSensorRequest>,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as StreamGatewayService>::record_sensor(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let fut = async move {
                        let method = RecordSensorSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
    ...
    pub const SERVICE_NAME: &str = "gateway.v1.StreamGatewayService";
